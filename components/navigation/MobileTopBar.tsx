...
export default function MobileTopBar({
  ...
  return (
    <header className="lg:hidden sticky top-0 z-40 flex w-full items-center gap-2 border-b border-sand-deep/60 bg-sand/95 pl-[max(1rem,env(safe-area-inset-left))] pr-[max(1rem,env(safe-area-inset-right))] pt-[max(0.75rem,env(safe-area-inset-top))] pb-3 backdrop-blur-md">
