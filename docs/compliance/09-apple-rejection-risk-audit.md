...
| 4 | **Reviewer can't access features** (no demo account / login wall) | 2.1 | 🔴 | Provide demo credentials + sample data in App Review notes; ensure Sign in with Apple works. |
| 5 | **Sign in with Apple missing** while offering Google login | 4.8 | 🔴 | Implement **Sign in with Apple** since third-party (Google) login is offered. Required. |
...
| 10 | **Subscription metadata** incomplete (no Terms/Privacy links, no restore, unclear renewal) | 3.1.1, 3.1.2 | 🟠 | Use Apple IAP for digital features; show price, period, auto-renew terms; link functional Privacy Policy + Terms (EULA); implement Restore Purchases. |
| 11 | **External purchase / payment links** for digital goods | 3.1.1, 3.1.3 | 🟠 | Do not link out to web payment for digital content from iOS; use IAP. (Physical goods/services exempt — N/A here.) |
...
account deletion. 4. Reviewer demo account + working sign-in. 5. **Sign in with Apple**
implemented. Do not submit until all five are true.
